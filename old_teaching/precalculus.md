...
permalink: /teaching/2021-fall-mat151
 ...
 * [Course Materials](https://activecalculus.org/prelude/book-1.html)
 ...
 * Office hour: Tuesdays and Thursdays 11:30am - 12:45pm in person, Wednesday 11:00am - 12:00pm (via Zoom by [appointment](https://ucxiao.youcanbook.me)).
 ...
 * Online homework system: We will use the WebAssign online homework system designed for Ron Larson's Precalculus textbook. You do not need to purchase the hard copy of Ron Larson's Precalculus textbook. If you want to have that textbook as a reference, you will have the access to an electronic version of it after you have purchase the WebAssign access. The ISBN for the WebAssign standalone access card is 9781337879613. You can also purchase the access directly from the publisher at [www.webassign.net](https://www.webassign.net). Note that it is very unlikely that any used Precalculus textbook will come with the WebAssign access.The class key you need to self-enroll in WebAssign is "utica 7392 8484". Please use your Utica College official name and email address to register at WebAssign. Do not use nickname or your private email address. If you have not purchased the access card or have purchased it but have not received it, please still go ahead and register after the first day of class as the WebAssign website will have a grace period and you can start to work on homework problems immediately.
 ...
 * Course description: Precalculus covers elementary functions and their graphs including linear functions, quadratic functions, exponential functions, logarithmic functions, rational functions and trigonometric functions.
...
## Course Learning Goals
 ...
 1. I can determine the domain and range of function given as an equation or a graph.
 2. I can compute average rate of changes of a function and using it to interpret the trend of the function.
 3. I can model a situation with appropriate linear functions and interpret the solution.
 4. I can model a situation with appropriate quadratic functions and interpret the solution.
 5. I can determine a composition of functions given in any form (graph, table, equation).
 6. I can determine the inverse of a function given in any form (graph, table, equation).
 7. I can determine and describe a transformation (translations, compressions, stretches, reflections) of a function given in forms of graphs or equations.  
 8. I can determine the equation of a circle in context and find the length of an arc of a circle or the area of a sector of a circle.
 9. I can determine an angle or its trigonometric values given other trigonometric values and the quadrant.
 10. I can determine transformation of sine and cosine functions given graphs or equations.
 11. I can solve equations that has expoential functions.
 12. I can model a situation with appropriate exponential functions and interpret the solution.
 13. I can solve equations that has logarithmic functions.
 14. I can model a situation with appropriate logarithmic functions and interpret the solution.
 15. I can use the definitions and properties of exponential and logarithmic functions to rewrite or simplify algebraic expressions.
 16. I can determine an appropriate function class (linear, quadratic, exponential, trigonometric) to model a particular situation.
 17. I can simplify functions using triangles that involve trigonometric and anti-trigonometric functions.
 18. I can determine the equation of a trigonometric function given its graph.
 19. I can prove trigonometric identities.
 20. I can indicate the vertical and the horizontal asymptotes of a given rational function.
