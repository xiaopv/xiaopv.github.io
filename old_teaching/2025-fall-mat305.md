 ...
 * 11/21/25
   * Complete 5.114 to 5.121. No weekly homework for this week.

 * 11/19/25
   * Complete 5.107 to 5.113.

 * 11/17/25
   * Complete 5.102 to 5.106.
   * Learning objectives for Exam 2:
     * 7. Be able to use mathematical induction to prove basic results in number theory.
     * 8. Be able to use strong mathematical induction to prove basic results in number theory.
     * 9. Be able to use the definition and the set operations to show that one set is a subset of another set, and to use that to show that two sets are equal.
     * 10. Be able to use basic properties of the power set of a set to prove basic facts.
     * 11. Be able to determine and show whether a relation is an equivalence relation and find equivalence classes.
     * 12. Be able to prove basic facts about functions including domain, codomain, range, image, and preimage.
   * Exam 2 is scheduled on Dec. 3. Make up for Exam 1 is scheduled on Dec. 5.

 * 11/14/25
   * Complete 5.91 to 5.101.
   * For weekly homework, do 5.90 and determine whether f(A\B) \subset f(A) \ f(B) is true or false. If true, prove it; if false, find a counterexample.

 * 11/12/25
   * Complete 5.84 to 5.89.
