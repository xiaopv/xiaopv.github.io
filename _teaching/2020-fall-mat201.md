...
* Week 15 (Nov. 30 - Dec. 5):
   
   * Dec 3:
     * Quiz available on Dec. 4 (due Saturday noon Dec. 5)
     * Please complete the student survey at soot.utica.edu
     * If you would like to sign up for more presentations, please do so asap.
     * Watch some videos:
       * [Screencast 3.4.1: Quick review -- Applied optimization](https://www.youtube.com/watch?v=Ilu2SZa3SYA&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=69)
       * [Screencast 3.4.2: Fencing Optimization](https://www.youtube.com/watch?v=jH6J-n6zt4c&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=70)
       * [Screencast 3.4.3: Optimization with trigonometry](https://www.youtube.com/watch?v=uJFxdxSBjok&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=71)

   * Dec. 1
     * Last WebAssign homework
     * Watch some videos:
       * [Screencast 3.3.1: Quick review -- Global optimization](https://www.youtube.com/watch?v=ldJfxeGHv3Y&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=66)
       * [Screencast 3.3.2: Finding absolute extreme values](https://www.youtube.com/watch?v=YE57SJzL8r8&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=67)
       * [Screencast 3.3.3: Optimizing population](https://www.youtube.com/watch?v=kz9JFNlQVVI&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=68)
 ...
 * Week 14 (Nov. 23 - Nov. 29):
   ...
   * Nov. 24
     ...
     * New Perusall reading assignment (due at the end of next week).
     * Quiz avaiable on Nov. 27 (due Saturday noon Nov. 28)
     * Let me know if you want to present Activity 3.3.3.
 ...
 * Week 13 (Nov. 16 - Nov. 22):
   * Nov. 19
     ...
     * Watch some videos:
       * [Screencast 3.1.5: Using the First Derivative Test](https://www.youtube.com/watch?v=9rg5jpFVSFY&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=59)
       * [Screencast 3.1.6: Second Derivative Test](https://www.youtube.com/watch?v=4Z_lhNVXEV4&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=60)
       * [Screencast 3.1.7: Identifying inflection points graphically](https://www.youtube.com/watch?v=Tyyo8kILvE0&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=61)
       * [Screencast 3.1.8: Finding inflection points](https://www.youtube.com/watch?v=w_O9IKmDZMI&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=62)

   * Nov. 17
     * New WebAssign and Perusall Assignment
     * Watch some videos:
       * [Screencast 3.1.1: Quick review -- Extreme values of functions](https://www.youtube.com/watch?v=Bzj_oXB6yIU&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=55)
       * [Screencast 3.1.2: Finding local and global extrema](https://www.youtube.com/watch?v=tvF3Rq0urvI&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=56)
       * [Screencast 3.1.3: Identifying critical values graphically](https://www.youtube.com/watch?v=7RcLQZdB0LM&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=57)
       * [Screencast 3.1.4: Finding critical values](https://www.youtube.com/watch?v=x-efl3Br11E&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=58)

 * Week 12 (Nov. 9 - Nov. 15):
   * Nov. 12
     * Quiz available on Nov. 13 (due Saturday noon Nov. 14)
     * Let me know if you wan to present Activity 3.5.5.

   * Nov. 10
     * New WebAssign and Perusall homework.
     * Watch some videos:
       * [Screencast 3.5.3: Related Rates Example with Trig](https://www.youtube.com/watch?v=44yHoaBCQ4Q&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=74)
 ...
 * Week 11 (Nov. 2 - Nov. 8):
   * Nov. 5
     ...
     * Watch some videos:
       * [Screencast 3.5.1: Quick review -- related rates](https://www.youtube.com/watch?v=Wh6UF4e55tg&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=72)
       * [Screencast 3.5.2: Basic related rates example](https://www.youtube.com/watch?v=2nnfWMI-wKM&list=PL9bIjQJDwfGuXQHuS5Jkmum_CFILoCZX-&index=73)
