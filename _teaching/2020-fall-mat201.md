 ...
 * Week 2 (Aug. 31 - Sep. 6):
   * Sep. 1
     ...
     * WebAssign Homework. One hint: To compute the instantaneous rates of change at the endpoints of the interval, you need to use the formula 
     ![image](https://latex.codecogs.com/gif.latex?\text{AV}_[a,a&plus;h]&space;=&space;\dfrac{s(a&plus;h)-s(a)}{h})
     and then let h goes to 0 to estimate.
