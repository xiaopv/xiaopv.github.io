 ...
 * 12/7/21:
   * Watch [Optimization Package](https://youtu.be/YBrxFIR601U) and [Optimization Power Line](https://youtu.be/cJa7E7PSLKk).
 ...
 * 11/23/21:
   ...
   * Watch [second derivative test](https://youtu.be/lilsi2exrmQ) and [finding global extrema](https://youtu.be/aiLNmqH9K4g).
   * If you are absent for this class, be sure to rewatch the two videos for 11/18/21.

 * 11/18/21:
   * Watch [global and local extrema](https://youtu.be/sNtJQQeuPp4) and [first derivative test](https://youtu.be/xJ15l-VvfS0)

 * 11/13/21:
   * Keep working on Activities 3.5.2, 3.5.3 and 3.5.5. Let me know if you want to present.
 
 * 11/11/21:
   * Watch [related rates sand cone](https://youtu.be/wH_sQaR7kaU).
   
 * 11/9/21:
   * Complete Activities 2.7.2 and 2.7.4. Let me know if you want to present. 
   * Watch [implicit differentiation complex example](https://youtu.be/KSKK3pXHF3k).
   
 * 11/4/21:
   * Watch [implicit differentiation motivating example](https://youtu.be/BRFX3gW_70c) and [implicit differentiation example](https://youtu.be/W8eACt_9O_g).

 * 11/2/21:
   * Complete Activity 2.6.4.
   * Watch [derivative of general inverse function](https://youtu.be/dPUV1cQxg_Y)

 * 10/28/21:
   * Complete Activity 2.5.4. 
   * Watch [derivative of log](https://youtu.be/sPj4lwiyibk) and [derivative of inverse trig](https://youtu.be/yEZbOGfIn2g)

 * 10/26/21:
   * Complete the rest of Activity 2.5.2 and Activity 2.5.3. Let me know if you want to present.
   * Watch [more chain rule](https://youtu.be/ziI6twXC3n8).

 * 10/21/21:
   * Complete Activity 2.3.4 and 2.4.4 before Tuesday's class. Let me know if you want to present.
   * Watch [more trig](https://youtu.be/qAzMNBx7cEc) and [chain rule](https://youtu.be/81YWHeFayR8)
 ...
 * 10/14/21:
   ...
   * Watch [product rule](https://youtu.be/73Bf5MhpDaw) and [quotient rule](https://youtu.be/Q1RJWGeeDtg).

 * 10/7/21:
   * Complete Activity 2.1.2.
   * Watch [differnetiation rule](https://youtu.be/lammmGrmApY) and [differentiate sine and cosine](https://youtu.be/QGkOEjQkQoY).
