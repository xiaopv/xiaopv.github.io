 ...
 * Dec. 3
   * No homework today. Work on your final portfolio.

 * Nov. 26
   * Complete the rest of Section 5.4.
   * Reminder: Exam 2 on Thursday.

 * Nov. 21
   * Skip Section 5.2 and 5.3. Start Section 5.4. Complete 5.73 to 5.83.
 ...
 * Nov. 19
   * Complete the rest of Section 5.1.

 * Nov. 14
   * Complete 5.26 to 5.42 (skip 5.28, 5.29 and 5.34).

 * Nov. 12
   * Complete 5.10 to 5.25.

 * Nov. 7
   * For this weekly homework, please two problems from the following list: 4.67+4.68 (as one problem), 4.71, 4.72, 4.73, 4.74, 4.75.
   * For next week, please complete 4.96 - 4.99 and start Chapter 5 to finish until 5.9.

 * Nov. 5
   * Complete 4.65, 4.66, 4.69 4.70, and 4.91 to 4.95.
   
 * Oct. 31
   * Complete Section 4.3 and 4.61, 4.62 in Section 4.4.
   
 * Oct. 29
   * Complete 4.18 to 4.31. We will move on to Section 4.2 next week.

 * Oct. 24
   * Start chapter 4 and section 4.1. Complete everything up to Question 4.17.

 * Oct. 22
   * Complete 3.30, 3.31, 3.34, 3.35, 3.44.
   * Weekly homework resumes this week.

 * Oct. 10
   * Try to complete the proof that if n is not divisible by 3, then the truncated n by n square can be tiled using trominoes.
   * Complete Question 3.20.
   * Read page 53 to page 58. Complete Question 3.25 to Statement 3.29.

 * Oct. 8
   * Work on Exploration 3.9, 3.10, 3.12 - 3.16.

 * Learning objectives for Exam 1:
   * Goal 1: Be able to determine if a sentence is a statement.
   * Goal 2: Be able to prove equivalence of compound statements that involve negation, conjunction, disjunction, and implication using the truth table and using the basic equivalence properties (such as the DeMorgan's Law).
   * Goal 3: Be able to negate a statement that involves one or more quantifiers.
   * Goal 4: Be able to use direct proof to prove basic results in number theory (such as oddness or evenness, or divisibility).
   * Goal 5: Be able to use proof by contrapositive to prove basic results in number theory.
   * Goal 6: Be able to use proof by contradiction to prove basic results in number theory.
