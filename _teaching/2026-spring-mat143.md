 ...
 * 4/14/26
   * Start working on Section 6.4 homework.
   * Section 6.5 [worksheet](https://www.dropbox.com/scl/fi/gz9fv3j4f3by8vvgx3s03/MAT_143_Section_6_5.pdf?rlkey=dyng9j9cjxst04zsm9h5ahjod&st=vjht7e51&dl=0).
   * Quiz 12 will cover Goal 13, 14, 15, 16, 17, 18, 19.

 * 4/9/26
   * Complete Section 6.3 homework.
   * Section 6.4 [worksheet](https://www.dropbox.com/scl/fi/7pth86ijepq85ldotgxsw/MAT_143_Section_6_4.pdf?rlkey=83gtpnm5fljc2ssq2vm75cyzm&st=awlifziu&dl=0).

 * 4/7/26
   * Start working on Section 6.3 homework.
   * Quiz 11 will cover Goal 8, 9, 10, 11, 12, 14, 16, 17.

 * 4/2/26
   * Complete Section 6.2 homework.
   * Section 6.3 [worksheet](https://www.dropbox.com/scl/fi/sru0j7367mkfwisli8vnz/MAT_143_Section_6_3.pdf?rlkey=5avp8hcfjrmlwxn9mkls1l5va&dl=0).
 ...
 * 3/24/26
   ...
   * Section 6.1 [worksheet](https://www.dropbox.com/scl/fi/jp00x9ykrhvl20itkj29r/MAT_143_Section_6_1.pdf?rlkey=kgibw1f3vcdt387q75c4xln2l&st=tx5uqd1v&dl=0).
   * Goal 9 will cover Goal 3, 4, 5, 9, 10, 13, 14, 15.

 * 3/19/26
   * Start working on Section 5.2 homework.
   * Section 5.3 [worksheet](https://www.dropbox.com/scl/fi/s9d0xj5af078aifa5qx70/MAT_143_Section_5_3.pdf?rlkey=yl3qkyfrjmrbjst593a8f2df6&st=ye2zol3r&dl=0).

 * 3/17/26
   * Complete Section 5.1 homework.
   * Quiz 8 will cover Goal 1, 2, 8, 12, 13, 15.

 * 3/3/26
   * Complete Section 4.2 homework.
   * Section 5.2 [worksheet](https://www.dropbox.com/scl/fi/m1qo36wwc6riy9po70e8v/MAT_143_Section_5_2.pdf?rlkey=wyst7t65kjd5qd00uyfr8i1v3&dl=0).
   * No meeting on 3/5. Work on Section 5.1 worksheet.
   * Quiz 7 will cover Goal 6, 7, 8, 12, 15.

 * 2/26/26
   * Start Section 4.2 homework.
   * Section 5.1 [worksheet](https://www.dropbox.com/scl/fi/6bqadml7ihfxeipbrmhf2/MAT_143_Section_5_1.pdf?rlkey=eycqaiq31474u4lad3ayc05sj&dl=0). 

 * 2/24/26
   * Complete Section 4.1 homework.
   * Section 4.2 [worksheet](https://www.dropbox.com/scl/fi/i1h1sb4zcxebcyipihjum/MAT_143_Section_4_2.pdf?rlkey=61zw94oa4xpmgp6ptg9tffwx7&dl=0).
   * Quiz 6 will cover Goal 5, 6, 7, 8, 11, 12.

 * 2/19/26
   * Complete Section 2.3 homework.
   * Section 4.1 [worksheet](https://www.dropbox.com/scl/fi/zurapb73slt8aowictjlr/MAT_143_Section_4_1.pdf?rlkey=ybgjzlqj27jtnnd7fr8cmmjjm&dl=0)
   
 * 2/17/26
   * Complete Section 2.2 homework.
   * Quiz 5 will cover Goal 4, 5, 6, 7, 11.
   * Section 2.3 [worksheet](https://www.dropbox.com/scl/fi/h0u6ezlisvulzzw1seusw/MAT_143_Section_2_3.pdf?rlkey=hzxeyqzhtfcb7s9k9zcju8l0m&dl=0)
 ...
 * 1/29/26
   * Complete Section 1.4 homework and start working on Section 1.5 homework.
   * Section 1.6 [worksheet](https://www.dropbox.com/scl/fi/v80msd9ro23f3ertpo2p9/MAT_143_Section_1_6.pdf?rlkey=we7mhe9i1edvuacezver7i4y6&dl=0).

 * 1/27/26
   * Complete Section 1.3 homework.
   * Section 1.5 [worksheet](https://www.dropbox.com/scl/fi/4delk48ew2gyuqpyyw3ib/MAT_143_Section_1_5.pdf?rlkey=s4tmtbepybk39mslnndhv2rhh&dl=0).
   * Quiz 2 will cover Goal 1, 2, 3.

 * 1/22/26
   * Complete Section 1.2 homework and start working on Section 1.3 homework in WebAssign.
   * Section 1.4 [worksheet](https://www.dropbox.com/scl/fi/s1iywa8lhd3oahhtbpzii/MAT_143_Section_1_4.pdf?rlkey=uva8uvwzgdj3px7cuvk3lzjvn&dl=0).
 ...
 * Class time and location: Hubbard Hall 210, Tuesdays and Thursdays, 10:00am - 11:15am
 ...
 * Online homework system: We will use the WebAssign online homework system designed for our textbook. You do not need to purchase the hard copy of the textbook and you will have the access to an electronic version of it after you have signed up the WebAssign access. The ISBN for the WebAssign standalone access card 9780357865095. If you have enrolled in the book bundle program, then you will automatically have access to it. Otherwise, you can purchase the access directly from the publisher. Note that it is very unlikely that any used textbook will come with the WebAssign access. You can click [this](https://www.getenrolled.com/?courseKey=utica58127849) to self-enroll or use the class key "utica 5812 7849". Please use your Utica University official name and email address to register. Do not use nickname or your personal email address.

 * Calculator: We will be using a free graphing calculator app called Desmos. You can use Desmos directly by going to their website at [www.desmos.com](https://www.desmos.com/calculator). You are required to bring a computer or a tablet to the class to use Desmos. You can download Desmos at [Apple](https://itunes.apple.com/us/app/desmos-graphing-calculator/id653517540?mt=8) or [Android](https://play.google.com/store/apps/details?id=com.desmos.calculator&amp;hl=en"). You are not allowed to use Desmos on a smart phone.
...
## Homework
  ...
  * The first kind is online homework assignment at WebAssign. There will be one WebAssign homework for each section. To earn credit, you must earn more than 90% on each assignment. You have 5 attempts for each question and that should be plenty before you can answer the question correctly. Each assignment is worth 1 point. WebAssign homework's deadline are scheduled much later in the semester. There will be no extension for WebAssign homework.
